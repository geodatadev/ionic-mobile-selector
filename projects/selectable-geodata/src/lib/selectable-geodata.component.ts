...
@Component({
	selector: 'lib-selectable-geodata',
	templateUrl: './selectable-geodata.component.html',
	styleUrls: ['./selectable-geodata.component.scss'],
})
export class SelectableGeodataComponent implements OnInit {
